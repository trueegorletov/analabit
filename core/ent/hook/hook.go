...
type CalculationFunc func(context.Context, *ent.CalculationMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CalculationFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CalculationMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f HeadingFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.HeadingMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f VarsityFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VarsityMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VarsityMutation", m)
}
