...
export POSTGRES_CONN_STRINGS="host=192.168.127.2 port=5433 user=postgres password=postgres dbname=postgres sslmode=disable"
export DATABASE_HOST="192.168.127.2"
export DATABASE_PORT="5433"
export DATABASE_USER="postgres"
export DATABASE_PASSWORD="postgres"
export DATABASE_DBNAME="postgres"
export DATABASE_SSLMODE="disable"
export CACHE_TTL_MINUTES="600"
export SELF_QUERY_PERIOD_MINUTES="150"
export DRAIN_SIM_ITERATIONS="10"
export VARSITIES_LIST="hse_nn,hse_spb,hse_msk,mipt"
