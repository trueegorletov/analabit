...
export POSTGRES_CONN_STRINGS="host=192.168.31.157 port=5433 user=postgres password=postgres dbname=postgres sslmode=disable"
export DATABASE_HOST="192.168.31.157"
...
export VARSITIES_LIST="mipt,mirea"
