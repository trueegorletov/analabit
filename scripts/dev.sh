...
export POSTGRES_CONN_STRINGS="host=100.66.77.155 port=5433 user=postgres password=postgres dbname=postgres sslmode=disable"
export DATABASE_HOST="100.66.77.155"
...
export VARSITIES_LIST="mipt,itmo,spbsu"
